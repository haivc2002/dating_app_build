class ModelResponseListPairing {
  String? result;
  String? message;
  List<Matches>? matches;

  ModelResponseListPairing({this.result, this.message, this.matches});

  ModelResponseListPairing.fromJson(Map<String, dynamic> json) {
    result = json['result'];
...
class Matches {
  ...
  Matches(
      {this.idUser, this.listImage, this.info, this.infoMore, this.newState});
