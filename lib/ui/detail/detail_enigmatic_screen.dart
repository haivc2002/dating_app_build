...
class DetailEnigmaticScreen extends StatefulWidget {
  static const String routeName = "/DetailEnigmaticScreen";
  const DetailEnigmaticScreen({super.key});

  @override
  State<DetailEnigmaticScreen> createState() => _DetailEnigmaticScreenState();
}

class _DetailEnigmaticScreenState extends State<DetailEnigmaticScreen> {
  ...
  Widget _btnLeftOrRight({required Color color, bool? border, int? match, required IconData icon}) {
    return Expanded(
